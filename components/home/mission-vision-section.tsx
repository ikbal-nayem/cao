        ...
        <div className="relative grid grid-cols-1 lg:grid-cols-2 gap-8 items-center">
          ...
          >
            <div className="bg-amber-500 text-white p-12 rounded-2xl relative overflow-hidden">
              ...
              <p className="text-lg leading-relaxed">
                Creating carbon-free cities by accelerating clean and renewable
                energy solutions in every home.
              </p>
            </div>
          </motion.div>
          ...
          >
            <div className="bg-purple-600 text-white p-12 rounded-2xl relative overflow-hidden">
              ...
              <p className="text-lg leading-relaxed">
                Generating sustainable renewable energy solutions to cover the
                demand of every home and industry all over the world.
              </p>
            </div>
          </motion.div>
        </div>
