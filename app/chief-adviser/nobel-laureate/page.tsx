	...
	return (
		<main className='min-h-screen py-24'>
			<div className='container mx-auto px-4'>
				<PageTitle title={t('nobelLaureatteTitle')} subTitle={t('nobelLaureatteSubTitle')} />
				...
				<div className='grid grid-cols-1 lg:grid-cols-2 gap-12 max-w-6xl mx-auto'>
					...
					>
						...
						<div className='prose prose-lg dark:prose-invert'>
							...
							<p>
								The Nobel Peace Prize 2006 was awarded to Muhammad Yunus and Grameen Bank "for their efforts
					...
					>
						...
						{achievements.map((achievement, index) => (
							<div key={achievement.year} className='relative pl-8 pb-8 border-l-2 border-primary last:pb-0'>
