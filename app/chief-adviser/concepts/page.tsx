  ...
  return (
    <main className="min-h-screen py-24">
      <div className="container mx-auto px-4">
        ...
        >
          <h1 className="text-4xl font-bold mb-6">Key Concepts</h1>
          <p className="text-xl text-muted-foreground max-w-3xl mx-auto">
            Core principles and innovative ideas that drive our vision for Bangladesh
          </p>
        </motion.div>
        ...
        >
          <h2>Our Approach</h2>
          <p>
            These concepts form the foundation of our approach to governance and development.
            We believe in creating sustainable solutions that empower communities and drive
            inclusive growth.
          </p>

          <h2>Implementation</h2>
          <p>
            Each concept is being implemented through specific programs and initiatives,
            designed to create measurable impact and lasting change in our society.
          </p>
        </motion.div>
      </div>
    </main>
