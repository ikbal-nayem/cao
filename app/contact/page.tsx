  ...
  return (
    <main className="min-h-screen">
      ...
      <section className="relative py-24">
        ...
        >
          <h1 className="text-6xl font-bold text-gray-700 dark:text-white mb-6">
            Contact Us
          </h1>
          <p className="text-lg text-gray-400 max-w-2xl mx-auto">
            Please feel free to reach out to us with any questions or inquiries
            you may have. We look forward to hearing from you and assisting you
            in any way possible.
          </p>
        </motion.div>
      </section>
        ...
        <div className="container relative mx-auto px-4">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
            ...
            <motion.div
              ...
              className="backdrop-blur-md shadow-xl bg-white/10 dark:bg-slate-900/50 rounded-lg p-8"
            >
