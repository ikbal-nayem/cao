export const bn = {
	...
	menu: {
		...
		advisersSpeeches: 'প্রধান উপদেষ্টার বক্তৃতামালা',
		cabinetMember: 'উপদেষ্টা পরিষদ',
		formerChiefAdvisers: 'প্রাক্তন প্রধান উপদেষ্টাগণ',
		organizationStructure: 'সাংগাঠনিক কাঠামো',
		ourTeam: 'কর্মকর্তা-কর্মচারীগণ',
		missionAndVision: 'অভিলক্ষ্য ও রূপকল্প/লক্ষ্য ও উদ্দেশ্য',
		...
		report: 'প্রতিবেদন ও পরিসংখ্যান',
		archiveTenders: 'দরপত্র',
		mediaGallery: 'গ্যালারী',
